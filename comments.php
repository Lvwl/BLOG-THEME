...
<?php else : ?>
	...
	<div id="respond">
		...
		<!-- comment input -->
		<div class="row">
			<textarea style="color:gray" onblur="if (this.value == '') {this.value = '节操留言~';} " onfocus="if (this.value == '节操留言~') {this.value = '';}" name="comment" id="comment" tabindex="4" rows="8" cols="50">节操留言~</textarea>
		</div>
		
		<!-- comment submit and rss -->
		<div id="submitbox">
			<!--<a class="feed" href="<?php bloginfo('comments_rss2_url'); ?>"><?php _e('Subscribe to comments feed', 'inove'); ?></a>-->
      <p>友情提示：留言可以使用大部分html标签和属性;</p>
    	 <p>添加代码示例:[code lang="cpp"]your code...[/code]</p>
       <p>添加公式请用Latex代码，前后分别添加两个$$</p>
