...
<?php if (have_posts()) : while (have_posts()) : the_post(); update_post_caches($posts); ?>
 <!-- <?php 
    echo do_shortcode("[metaslider id=4775]"); 
?>-->
    
	<div class="post" id="post-<?php the_ID(); ?>">
    <div class="mydate">

						<div class="mymonth"><?php the_time(y) ?>-<?php the_time(n) ?></div>

						<div  class="myday"><?php the_time(d) ?></div>
      ...
      <!--<div class="view"> <?php echo getPostViews(get_the_ID()); ?>次围观</div>-->
